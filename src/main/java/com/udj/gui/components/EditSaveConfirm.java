...
public class EditSaveConfirm extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EditSaveConfirm.class.getName());
    private boolean confirmed = false;
    
    public EditSaveConfirm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        ESBG = new com.udj.gui.components.ButtonLabelBG();
        ...
        ESBG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/EditandSave.png"))); // NOI18N
        getContentPane().add(ESBG, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
